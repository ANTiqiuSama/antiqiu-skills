...
用户交来已有文本时，原文已经是初稿，可以直接使用本文件。明确要求去除 AI 痕迹或诊断模型腔时，另读 `references/humanizing.md`。去痕不能越过原意、事实、立场、人称与语气的保真边界。
...
它还会提醒模糊归因、宣传套话、聊天残留、过度限定、粗体堆叠和模板化乐观结尾。这些都是审稿线索，不是绝对禁令。编辑需要回到原文目的判断，尤其不能把准确的来源限定、必要的品牌措辞和适合清单呈现的内容机械改掉。
